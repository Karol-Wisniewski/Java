    ...
    public static void main(String[] args) {
        ...
        while (option != 9) {
            switch (option) {
                ...
                case 3 -> System.out.println("The base surface area of the cylinder is: " + cylinder.getBaseSurfaceArea());
                case 4 -> System.out.println("The side surface area of the cylinder is: " + cylinder.getSideSurfaceArea());
